...
// CHANGE HTML CONTENT
document.getElementById("column1").innerHTML = "Column 1 updated by JavaScript!";
document.getElementById("column2").innerHTML = "Column 2 updated by JavaScript!";

// LOGIC 
let score = 10;

if (score > 5) {
    document.getElementById("column1").innerHTML += "<br>logic test! PASSED!";
} else {
    document.getElementById("column1").innerHTML += "<br>Try again!";
}
